export let gameTypes = [
  ...
  },
  {
    ...
    url: "https://cdn.discordapp.com/attachments/1054239396024549486/1171667786343395348/woocommerce-15.jpg?ex=655d83a8&is=654b0ea8&hm=25031174744dd94b29abc8f2faff18c5d6b827899ad12db9cb6dc08bc91ed0ca&",
    possibleCoordinates: [
      { lat: 33.94947429867073, lng: -83.37684367713983, radius: 60 }, //
    ],
  },
  // {
  //   id: "4222",
  ...
  //     // { lat: 33.93102319795355, lng: -83.37369435837667, radius: 555 }, //
  //     // { lat: 33.92912197515169, lng: -83.37191852002927, radius: 555 }, //
  //     // { lat: 33.92691175029099, lng: -83.38543780576636, radius: 555 }, //
  //     // { lat: 33.92691175029878, lng: -83.3744390647804, radius: 555 }, //
  //     // { lat: 33.94526646215142, lng: -83.36523750680715, radius: 555 }, //
  //     // { lat: 33.94891552136928, lng: -83.36879948020291, radius: 555 }, //
  //   ],
  // },
  // {
  //   id: "15",
  ...
  //   possibleCoordinates: [
  //     { lat: 33.951752641469085, lng: -83.37435458710178, radius: 555 }, // center of UGA
  //     { lat: 33.93307374280034, lng: -83.37205409908691, radius: 555 }, // IM deck
  //   ],
  // },
  // {
  //   id: "64",
